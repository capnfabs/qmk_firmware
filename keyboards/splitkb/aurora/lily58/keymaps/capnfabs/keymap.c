...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(
		...
		KC_LSFT,	KC_Z,	KC_X,	KC_C,	KC_V,	KC_B,	KC_NO,RGB_TOG,	KC_N, 		KC_M, 	KC_COMM,	KC_DOT,	KC_SLSH,	KC_NO,
								KC_LCTL, KC_LALT, KC_LGUI, KC_SPC,RGB_MODE_FORWARD, RGB_TOG, RGB_TOG, RGB_TOG),
	[1] = LAYOUT(
		...
		MO(3), XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
